...
<Typography variant="body1" style={{ color: '#000000' }}>
  ...
  <br />
  Uso: <a href="https://platform.openai.com/usage" style={{ color: '#000000' }}>https://platform.openai.com/usage</a>
  <br />
  Fatura: <a href="https://platform.openai.com/account/billing/overview" style={{ color: '#000000' }}>https://platform.openai.com/account/billing/overview</a>
  <br />
  API: <a href="https://platform.openai.com/api-keys" style={{ color: '#000000' }}>https://platform.openai.com/api-keys</a>
</Typography>
*/}
